...
var _StreamLoader_instances, _StreamLoader_app, _StreamLoader_fileInfoStore, _StreamLoader_cb, _StreamLoader_handleUpload, _StreamLoader_handleHandshake, _StreamLoader_handleTransfered;
...
_StreamLoader_app = new WeakMap(), _StreamLoader_fileInfoStore = new WeakMap(), _StreamLoader_cb = new WeakMap(), _StreamLoader_instances = new WeakSet(), _StreamLoader_handleUpload = function _StreamLoader_handleUpload(req, res) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            fileInfo['writeStream'] = node_fs_1.default.createWriteStream(path_1.default.join(fileInfo['destination'] + '/' + fileInfo['fileName'])).on('ready', () => {
